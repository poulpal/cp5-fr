  ...
  const refreshData = async () => {
    ...
    try {
      const response = await axios.get(
        `/building_manager/banks?paginate=1&page=${page}&perPage=${perPage}&sort=${sort}&order=${order}`
      );
    ...
    <>
      ...
      >
        <div className="pb-5 pt-2">
          <h3 className="text-center mb-1">بانک ها</h3>
          {/* <FloatingAddButton
