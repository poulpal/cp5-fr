...
export default () => {
    ...
    const loadMore = async () => {
        ...
        try {
            const response = await axios.get(
                "/building_manager/forumPosts?page=" + (page + 1)
            );
                                ...
                                <CardBody>
                                    <form
                                        onSubmit={async (e) => {
                                            ...
                                            try {
                                                setLoading(true);
                                                const response = await axios.post("/building_manager/forumPosts", newPost, {
                                                    headers: {
                                        ...
                                        <CardFooter>
                                            <div className="d-flex justify-content-end align-items-center">
                                                ...
                                                <div className="pointer" onClick={async () => {
                                                    try {
                                                        setLoading(true);
                                                        const response = await axios.post(`/building_manager/forumPosts/${post.id}/like`, {
                                                            unit: localStorage.getItem("selectedUnit"),
                                                        });
