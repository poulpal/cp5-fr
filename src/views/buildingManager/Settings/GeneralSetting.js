...
const ChargeSetting = () => {
    ...
    const refreshData = async () => {
        ...
        try {
            ...
            setValue('auto_add_monthly_rent', options.auto_add_monthly_rent && true);
            setValue('charge_day', options.charge_day);
            setValue('rent_day', options.rent_day);
            ...
            setValue('show_costs_to_units', options.show_costs_to_units && true);
            setValue('show_stocks_to_units', options.show_stocks_to_units && true);
            setValue('show_balances_to_units', options.show_balances_to_units && true);
            setLoading(false);
        } catch (error) {
            setLoading(false);
        ...
        <>
            ...
            >
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <h4 className="mb-2">
                        تنظیمات نمایش اطلاعات به واحد ها
                    </h4>
                    <Row>
                        <Col md="6" className="mb-3">
                            <Label>نمایش هزینه های ساختمان در پنل واحد: </Label>
                            <br />
                            <Controller
                                name="show_costs_to_units"
                                control={control}
                                render={({ field }) => (
                                    <input
                                        type="checkbox"
                            ...
                            <br />
                            <small>
                                در صورت فعال بودن این گزینه هزینه های ساختمان برای ساکنین در پنل واحد نمایش داده خواهد شد.
                            </small>
                            {errors.show_costs_to_units && (
                                <div className="text-danger">
                                    {errors.show_costs_to_units.message}
                                </div>
                            )}
                        </Col>
                        <Col md="6" className="mb-3">
                            <Label>نمایش موجودی انبار در پنل واحد: </Label>
                            <br />
                            <Controller
                                name="show_stocks_to_units"
                                control={control}
                                render={({ field }) => (
                                    <input
                                        type="checkbox"
                            ...
                            <br />
                            <small>
                                در صورت فعال بودن این گزینه موجودی انبار برای ساکنین در پنل واحد نمایش داده خواهد شد.
                            </small>
                            {errors.show_stocks_to_units && (
                                <div className="text-danger">
                                    {errors.show_stocks_to_units.message}
                                </div>
                            )}
                        </Col>
                        <Col md="6" className="mb-3">
                            <Label>نمایش موجودی صندوق ها در پنل واحد: </Label>
                            <br />
                            <Controller
                                name="show_balances_to_units"
                                control={control}
                                render={({ field }) => (
                                    <input
                                        type="checkbox"
                            ...
                            <br />
                            <small>
                                در صورت فعال بودن این گزینه موجودی صندوق ها برای ساکنین در پنل واحد نمایش داده خواهد شد.
                            </small>
                            {errors.show_balances_to_units && (
                                <div className="text-danger">
                                    {errors.show_balances_to_units.message}
                                </div>
                            )}
                        </Col>
                    ...
                    <h4 className="mb-2">
                        تنظیمات پرداخت اجاره، شارژ و جریمه
                    </h4>
                    <Row>
                        <Col md="6" className="mb-3">
                        ...
                        <Col md="6" className="mb-3">
                            <Label>اعمال اتوماتیک اجاره: </Label>
                            <br />
                            <Controller
                                name="auto_add_monthly_rent"
                                control={control}
                                render={({ field }) => (
                                    <input
                                        type="checkbox"
                            ...
                            <br />
                            <small>
                                در صورت فعال بودن این گزینه، هر ماه اجاره هر واحد که دارای مستاجر باشد به صورت اتوماتیک به عنوان بدهی اعمال می شود.
                            </small>
                            {errors.auto_add_monthly_rent && (
                                <div className="text-danger">
                                    {errors.auto_add_monthly_rent.message}
                                </div>
                            )}
                        </Col>

                        <Col md="6" className="mb-3">
                            <Label>روز اعمال اتوماتیک اجاره: </Label>
                            <Controller
                                name="rent_day"
                                control={control}
                                rules={{ required: "وارد کردن این فیلد الزامی است" }}
                                render={({ field }) => (
                                    <select
                                        className="form-control"
                                        {...field}
                                        disabled={!watch('auto_add_monthly_rent')}
                                    >
                                        {_.range(1, 30).map((day) => (
                                            <option key={day} value={day}>{day}</option>
                                        ))}
                            ...
                            />
                            {watch('auto_add_monthly_rent') ? (
                                <small>
                                    در آغاز روز <strong>{toOrderdFarsi(watch('rent_day'))}</strong> هر ماه اجاره هر واحد به صورت اتوماتیک به عنوان بدهی اعمال می شود.
                                </small>) : <></>
                            }
                            {errors.rent_day && (
                                <div className="text-danger">
                                    {errors.rent_day.message}
                                </div>
                            )}
                        </Col>
                        <Col md="4" className="mb-3">
                            <Label>خسارت تاخیر در پرداخت بدهی: </Label>
                            <br />
                            <Controller
                                name="late_fine"
                                control={control}
                            ...
                            <br />
                            <small>
                                در صورت فعال بودن این گزینه در هر ماه خسارت تاخیر در پرداخت بدهی برای واحد های بدهکار اعمال خواهد شد.
                            </small>
                            {errors.late_fine && (
                                <div className="text-danger">
                        ...
                        <Col md="4" className="mb-3">
                            <Label>درصد خسارت تاخیر در پرداخت بدهی: </Label>
                            <Controller
                        ...
                        <Col md="4" className="mb-3">
                            <Label>روز اعمال خسارت تاخیر در پرداخت بدهی: </Label>
                            <Controller
                                name="late_fine_days"
                                control={control}
                                rules={{ required: "وارد کردن این فیلد الزامی است" }}
