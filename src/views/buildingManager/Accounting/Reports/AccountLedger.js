...
export default () => {
    ...
    useEffect(() => {
        setPage(0);
        refreshData();
    }, [rangeStart, rangeEnd, account, detail]);
    ...
    return (
        <Paper style={{ borderRadius: "20px", minHeight: "89vh", marginBottom: "20px", paddingBottom: "5px" }}>
            ...
            <h3 className="text-center mb-0 pt-1 pb-0">دفتر حساب</h3>
            <div className="py-1 px-2 d-flex justify-content-between align-items-center">
                <div className='d-flex justify-content-between align-items-center'>
                    ...
                    <AccountSelector accounts={accounts} account={account} setAccount={setAccount} />
                    <div className='ms-1'></div>
                    <AccountSelector
                        account={detail}
                        setAccount={setDetail}
                        accounts={details}
                        placeholder="انتخاب تفضیل"
                    />
                </div>
                <div>
                    <ExportToExcel
