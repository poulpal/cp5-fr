...
export default ({ show, setShow, setLoading, refreshData, data }) => {
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            ...
            const response = await axios.put(
                "building_manager/accounting/details/" + data.id,
                formData
            );
    ...
    return (
        <Modal
            ...
            unmountOnClose={true}
        >
            <ModalHeader toggle={() => setShow(false)}>ویرایش تفضیل</ModalHeader>
            <ModalBody>
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <Row>
                        <Col md={12}>
                            ...
                            {errors.name && (
                                <div className="text-danger">نام تفضیل را وارد کنید</div>
                            )}
                        </Col>
                        <Col md={12}>
                            <div className="mt-1">
