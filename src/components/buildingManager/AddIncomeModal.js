...
import AddMultipleIncome from "./addMultipleIncome";
...
const AddIncomeModal = ({ show, setShow, setLoading, refreshData }) => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={() => setShow(false)}>افزودن درآمد</ModalHeader>
      <ModalBody>
        <Nav pills justified>
          <NavItem>
            <NavLink
