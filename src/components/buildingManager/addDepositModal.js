...
import AddMultipleDeposit from "./addMultipleDeposit";
...
const AddDepositModal = ({ show, setShow, setLoading, refreshData, isModal = true }) => {
  if (!isModal) {
    return (
  ...
  return (
    ...
    >
      <ModalHeader toggle={() => setShow(false)}>افزودن پرداختی</ModalHeader>
      <_AddDepositModal
        show={show}
        setShow={setShow}
        setLoading={setLoading}
...
const _AddDepositModal = ({ show, setShow, setLoading, refreshData }) => {
  ...
  const getUnits = async () => {
    try {
      ...
      const response2 = await axios.get("/building_manager/accounting/details?type=bank");
      setBanks(response2.data.data.details);
    } catch (err) {
      console.log(err);
              ...
              <Row>
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select
                          ...
                          value={field.value}
                          onChange={(value) => {
                            setSelectedUnit(units.find((unit) => unit.id === value.value));
                ...
                {/* {selectedUnit && (
                  <span className="w-100">
                    <h5 className="mt-3">
                      واحد {selectedUnit.unit_number} - {selectedUnit.charge_deposit}
                    </h5>
                  </span>
                )} */}
                <Col md={12}>
                  <div className="mt-1">
                    ...
                    />
                    {errors.amount && (
                      <div className="text-danger">مبلغ پرداختی را وارد کنید</div>
                    )}
                  </div>
                </Col>
                <Col md={12}>
                ...
                {/* <Col md={12}>
                  ...
                  {errors.description && (
                    <div className="text-danger">شماره فیش را وارد کنید</div>
                  )}
                </Col> */}
                {/* <Col md={12}>
                  <div className="mt-1">
                  ...
                  {errors.description && (
                    <div className="text-danger">نام بانک را وارد کنید</div>
                  )}
                </Col> */}
                <Col md={12}>
                  <div className="mt-1">
